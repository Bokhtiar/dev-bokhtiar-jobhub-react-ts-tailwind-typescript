  ...
  return (
    <div className="bg-gray-200">
      <div className="w-full xl:w-3/4 mx-auto">
        <div className="px-6 xl:px-0 py-24 lg:py-48">
          <div className="text-5xl lg:text-8xl text-center font-bold">
            Find the most exciting start new job
          </div>
          <div className="flex w-full md:w-1/2 lg:w-2/5 mx-auto my-20">
            <input
              type="text"
