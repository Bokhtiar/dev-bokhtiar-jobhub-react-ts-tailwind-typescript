export const Footer = () => {
  return (
    <div className="shadow-md my-8 bg-zinc-800 text-stone-100">
      <div className=" my-4 mx-auto max-w-7xl px-4">
        <div className="grid grid-cols-3 gap-4">
          <div>
            <h2 className="text-center text-2xl text-gray-600 text-stone-100">Compnay Name</h2>
            <p className="my-4">
          ...
          <div>
            <h2 className=" text-center text-2xl text-gray-600 text-stone-100">Quick Links</h2>
          ...
          <div>
            <h2 className=" text-center text-2xl text-gray-600 text-stone-100">Follow Us</h2>
            <p className="text-center my-4">
              <ul className="list-inside">
                <li>Facebook</li>
                <li>Gmail</li>
          ...
          <div className="sm:flex sm:items-center sm:justify-between">
            <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400"> <a href="" className="hover:underline"></a>Compnay name.
            </span>
